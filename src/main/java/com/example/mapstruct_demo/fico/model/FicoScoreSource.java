...
public class FicoScoreSource {
    private String ficoScoreRanking;
    private String ficoScoreReason1;
    private String ficoScoreReason2;
    private String ficoScoreReason3;
    private String ficoScoreReason4;
    private String ficoScoreReason5;
    private Integer ficoScore;
    private String scoreRankMax;
    private String scoreRankMin;
